      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            <div
              className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 ${darkMode ? "bg-gradient-to-br from-purple-600 to-blue-600" : "bg-gradient-to-br from-purple-500 to-blue-500"}`}>
              <svg
          ...
          <p
            className={`text-lg ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
            {hailingFrequency?.toString() ?? "-"}
          </p>
        </div>

        {/* Settings Container */}
        <div
          className={`rounded-2xl shadow-2xl ${darkMode ? "bg-gray-800 border border-gray-700" : "bg-white border border-gray-200"} overflow-hidden`}>
          {/* Theme Toggle */}
          <div
              ...
              <div className="flex items-center space-x-2">
                <svg
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M15 7a2 2 0 012 2m0 0a2 2 0 012 2m-4-4v2m0-2h2m-2 0H9m0 0a2 2 0 00-2 2m0 0a2 2 0 002 2m-4-4v2m0-2h2m6 0a2 2 0 012-2m0 0a2 2 0 012 2m0 0V9a2 2 0 00-2-2h-2m6 4a2 2 0 002-2m0 0V7a2 2 0 00-2-2h-2m0 10v2m0-2h2m-2 0h-2"
                  />
                </svg>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setSummarizationModel(e.target.value as any)
                    }
                    className={`w-full px-4 py-3 rounded-lg border transition-colors ${
                      darkMode
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-lg border">
                  <div className="flex items-center space-x-3">
                    <div
                      className={`w-2 h-2 rounded-full ${autoSummarize ? "bg-green-500" : "bg-gray-400"}`}></div>
                    <div>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border">
                  <div className="flex items-center space-x-3">
                    <div
                      className={`w-2 h-2 rounded-full ${showThumbnails ? "bg-green-500" : "bg-gray-400"}`}></div>
                    <div>
